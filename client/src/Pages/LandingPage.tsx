      ...
      <div className="relative z-10">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-20">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 mt-16 sm:mt-20 max-w-4xl mx-auto px-4">
            {[
              { number: '1M+', label: 'Emails Processed' },
              ...
              {[
                {
                  ...
                  content: 'MailX has revolutionized my email workflow. The intelligent categorization helps me focus on what truly matters.',
                  image: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=crop&w=150&h=150',
                },
                {
                  name: 'Keerthan Reddy',
                  role: 'Product Manager',
                  content: 'The smart email prioritization feature is a lifesaver. I never miss important messages anymore!',
                  image: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=150&h=150',
                },
                {
                  name: 'Bhanu Prakash',
                  role: 'Business Owner',
                  content: 'MailX has streamlined my communication process. The AI insights help me respond faster and more effectively.',
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
              <div>
                ...
                <ul className="space-y-2">
                  ...
                  <li><a href="https://aistudio.google.com/api-keys" className="text-gray-400 hover:text-white transition-colors">API</a></li>
                </ul>
              </div>
              <div>
              ...
              <div>
                ...
                <div className="flex space-x-4">
                  <a href="https://github.com/KiranTejz20005" className="text-gray-400 hover:text-white transition-colors">
                    <Github className="w-6 h-6" />
                  </a>
                  <a href="#" className="text-gray-400 hover:text-white transition-colors">
                    <Twitter className="w-6 h-6" />
                  </a>
                  <a href="https://www.linkedin.com/in/kirantejalanke/" className="text-gray-400 hover:text-white transition-colors">
            ...
            <div className="mt-12 pt-8 border-t border-purple-800/30 flex flex-col md:flex-row justify-between items-center">
              ...
              <div className="text-gray-400 text-center md:text-left">
                © 2025 MailX. All rights reserved.
              </div>
            </div>
          </div>
        </footer>
